...
protocol ViewControllerLifecycleBehavior {
    ...
    func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?, viewController: UIViewController)
}
...
extension UIViewController {
    ...
    func addBehavior(_ behavoir: ViewControllerLifecycleBehavior) {
        addBehaviors([behavoir])
    }
    ...
    private final class LifecycleBehaviorViewController: UIViewController, UIGestureRecognizerDelegate {
        ...
        override func viewDidLoad() {
            ...
            registerForTraitChanges([UITraitUserInterfaceStyle.self]) { (self: Self, previousTraitCollection: UITraitCollection) in
                self.applyBehaviors { behavior, viewController in
                    behavior.traitCollectionDidChange(previousTraitCollection, viewController: viewController)
                }
            }
        }
